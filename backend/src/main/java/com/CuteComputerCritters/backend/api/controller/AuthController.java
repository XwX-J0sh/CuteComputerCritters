...
import com.CuteComputerCritters.backend.api.payload.request.user.LoginRequest;
import com.CuteComputerCritters.backend.api.payload.request.user.SignupRequest;
...
@RestController
//Maps all Requests in here to /auth...
@RequestMapping("/auth")
