...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if(critterEvolutionsRepository.count() == 0){
            critterEvolutionsRepository.save(new CritterEvolution(1.0, 30, 5, 1, 1, 50, 50, 1, "Baby"));
            critterEvolutionsRepository.save(new CritterEvolution(2.0, 30, 5, 2, 2, 40, 40, 1, "Chiikawa"));
            critterEvolutionsRepository.save(new CritterEvolution(2.1, 30, 5, 2, 1, 30, 50, 1.5, "Hachiware"));
            critterEvolutionsRepository.save(new CritterEvolution(2.2, 30, 5, 1, 1, 20, 30, 2, "Schisa"));
            critterEvolutionsRepository.save(new CritterEvolution(2.3, 25, 10, 3, 1, 60, 60, 0.75, "Usagi"));
            critterEvolutionsRepository.save(new CritterEvolution(2.4, 30, 10, 3, 3, 60, 80, 0.5,"Momonga"));
        }
    }
}
